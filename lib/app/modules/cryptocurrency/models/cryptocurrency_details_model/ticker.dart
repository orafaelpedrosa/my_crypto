...
class Ticker {
  ...
  factory Ticker.fromMap(Map<String, dynamic> map) {
    return Ticker(
      ...
      convertedLast: map['converted_last'] != null
          ? ConvertedLast.fromMap(map['converted_last'])
          : null,
      convertedVolume: map['converted_volume'] != null
          ? ConvertedVolume.fromMap(map['converted_volume'])
          : null,
